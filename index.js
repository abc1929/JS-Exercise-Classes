...
class Instructor extends Lambdasian {
  ...
  grade2(student) {
    ...
    // Say if student grade is 60, it can randomly add a num from -60 to 40
  }
}
...
class Student extends Lambdasian {
  ...
  listSubjects() {
    return (
      "Loving " +
      this.favSubjects.reduce((a, b) => a + b + ", ", "").slice(0, -2) +
      "!"
    );
  }
...
// student.graduate() returns a boolean
// instructor.grade2() checks whether a student can graduate or else it would randomly regrade the student.
